...
public class PhongChieu_UI extends JFrame implements ActionListener, MouseListener{
	/**
	 * 
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnCapNhatPC) {
		    ...
		    if (selectedRow == -1) {
		        JOptionPane.showMessageDialog(null, "Vui lòng chọn một phòng chiếu để cập nhật.", "Thông báo", JOptionPane.WARNING_MESSAGE);
		    } else {
		        String maPC = txtMaPC.getText();
		        String tenPC = txtTenPC.getText();
		        ...
		        try {
		            ...
		            JOptionPane.showMessageDialog(null, "Cập nhật thông tin phòng chiếu thành công.", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
		        } catch (Exception ex) {
		            ex.printStackTrace();
		            JOptionPane.showMessageDialog(null, "Cập nhật thông tin phòng chiếu thất bại.", "Thông báo", JOptionPane.ERROR_MESSAGE);
		        }
		    }
		}
	...
	public void loaddataPhongChieu() {
	    ...
	    for (PhongChieu phong : danhSachPhongChieu) {
	        tablemodel.addRow(new Object[] { phong.getMaPC(), phong.getTenPC(), phong.getDienTich(), phong.isTrangThai()});
	    }
	}
